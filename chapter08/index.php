...
if ($token) {
  ...
  $likes = array_values(
    idx(FBUtils::fetchFromFBGraph("me/likes?access_token=$token&limit=$LIMIT"), 'data')
  );

  // This fetches 4 of your friends.
  $friends = array_values(
    idx(FBUtils::fetchFromFBGraph("me/friends?access_token=$token&limit=$LIMIT"), 'data')
  );
...
<html lang="en">
  <head>
    ...
    <meta property="og:url" content="https://young-sky-9602.herokuapp.com/">
    <meta property="og:title" content="Liquidfoot Games">
    <meta property="og:type"        content="game.achievement" /> 
    <meta property="og:url"         content="http://www.liquidfoot.com/" /> 
